	...
	const dummyData = [
		{
			snippet: {
				authorProfileImageUrl:
					'https://yt3.ggpht.com/WggXR-cqxBtQN9zX9BpUX6gNTkn_zNjMAIzDe_n4SQP90MLrrqywFqWNSnljNuDWx9dQ_urf=s68-c-k-c0x00ffffff-no-rj',
				authorDisplayName: '@maccosmetics',
				publishedAt: '2023-12-06T19:45:13Z',
				textDisplay:
					'Ex harum temporibus laboriosam esse accusamus ea voluptates cumamet, omnis, eius aliquid nihil, consectetur quia. Dolor perferendis quidem illum nesciunt',
				likeCount: 10,
			},
		},
	];
